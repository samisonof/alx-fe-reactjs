function UserProfile() {
    return (
      <div className="user-profile bg-gray-100 md:p-8 sm:p-4 max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-lg">
        <img className="rounded-full sm:w-24 sm:h-24 md:w-36 md:h-36 mx-auto hover:scale-110 hover:text-blue-500 hover:shadow-xl transition-transform duration-300 ease-in-out" src="https://via.placeholder.com/150" alt="User"/>
